        ...
        if (creation == true)
        {
            if (ImGui.BeginChild("CHARACTER SHEET CREATION", new Vector2(500, 850), true))
            {
                ...
                if (ImGui.Button("Create Character"))
                {
                    if (abilityCount == 0)
                    {
                        DataSender.CreateProfile(Plugin.Configuration.username, PlayerName, CharacterName, this.avatarBytes, this.avatarBytes.Length, Race, Age, Height, Weight, health, strength, senses, hardiness, intelligence, nimbleness, eminence, "","","","","","");
                    }
                    if (abilityCount == 1)
                    {
                        DataSender.CreateProfile(Plugin.Configuration.username, PlayerName, CharacterName, this.avatarBytes, this.avatarBytes.Length, Race, Age, Height, Weight, health, strength, senses, hardiness, intelligence, nimbleness, eminence, Ability1Name, "", "", Ability1Description, "", "");

                    }
                    if (abilityCount == 2)
                    {
                        DataSender.CreateProfile(Plugin.Configuration.username, PlayerName, CharacterName, this.avatarBytes, this.avatarBytes.Length, Race, Age, Height, Weight, health, strength, senses, hardiness, intelligence, nimbleness, eminence, Ability1Name, Ability2Name, "", Ability1Description, Ability2Description, "");
                    }
                    if (abilityCount == 3)
                    {
                        DataSender.CreateProfile(Plugin.Configuration.username, PlayerName, CharacterName, this.avatarBytes, this.avatarBytes.Length, Race, Age, Height, Weight, health, strength, senses, hardiness, intelligence, nimbleness, eminence, Ability1Name, Ability2Name, Ability3Name, Ability1Description, Ability2Description, Ability3Description);
                    }
                }
