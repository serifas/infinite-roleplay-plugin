...
namespace InfiniteRoleplay.Windows
{
    internal class AdminWindow : Window, IDisposable
    {
        ...
        public AdminWindow(Plugin plugin,TextureWrap hpImage, TextureWrap emnImage, TextureWrap hrdImage, TextureWrap intImage, TextureWrap nimImage, TextureWrap senImage, TextureWrap strImage,
                                        ...
                                        TextureWrap ngBar, TextureWrap avatarHolder, DalamudPluginInterface Interface) : base(
       "ADMINISTRATION", ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoScrollWithMouse)
        {
            ...
            this.EminenceImage = emnImage; this.EminenceBar = emnBar;
            this.HardinessImage = hrdImage; this.HardinessBar = hrdBar; 
            this.IntelligenceImage = intImage; this.IntelligenceBar = intBar; 
            this.NimblenessImage = nimImage; this.NimblenessBar = nimBar; 
            this.SensesImage = senImage; this.SensesBar = senBar;
            this.StrengthImage = strImage; this.StrengthBar = strBar;
